const AnimationWireframeSection = () => {
  return (
    <footer className="bg-[#161515] py-10 px-4">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:justify-between md:items-start gap-8">
        <div>
          <h2 className="text-3xl font-bold text-white mb-2">Alra Labs</h2>
          <p className="text-gray-400 mb-1">Innovating the Future with Intelligent</p>
          <p className="text-gray-400">AI Solutions</p>
        </div>
        <div className="flex flex-col md:flex-row gap-8 flex-1 justify-between">
          <div>
            <h3 className="text-white font-semibold mb-2">Why Alra labs ?</h3>
          ...
          <div>
            <h3 className="text-white font-semibold mb-2">Webinar</h3>
            <ul className="text-gray-300 space-y-1">
              <li>Newsrooms</li>
          ...
          <div>
            ...
            <div className="flex space-x-3 mt-2">
              <a href="#" aria-label="LinkedIn" className="text-blue-400 hover:text-blue-500"><svg width="24" height="24" fill="currentColor" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-10h3v10zm-1.5-11.268c-.966 0-1.75-.784-1.75-1.75s.784-1.75 1.75-1.75 1.75.784 1.75 1.75-.784 1.75-1.75 1.75zm13.5 11.268h-3v-5.604c0-1.337-.025-3.063-1.868-3.063-1.868 0-2.154 1.459-2.154 2.968v5.699h-3v-10h2.881v1.367h.041c.401-.761 1.381-1.563 2.841-1.563 3.039 0 3.6 2.001 3.6 4.599v5.597z"/></svg></a>
              <a href="#" aria-label="X" className="text-white hover:text-gray-400"><svg width="24" height="24" fill="currentColor" viewBox="0 0 24 24"><path d="M17.53 6.47a.75.75 0 0 0-1.06 0L12 10.94 7.53 6.47a.75.75 0 0 0-1.06 1.06L10.94 12l-4.47 4.47a.75.75 0 1 0 1.06 1.06L12 13.06l4.47 4.47a.75.75 0 0 0 1.06-1.06L13.06 12l4.47-4.47a.75.75 0 0 0 0-1.06z"/></svg></a>
              ...
              <a href="#" aria-label="Facebook" className="text-white hover:text-gray-400"><svg width="24" height="24" fill="currentColor" viewBox="0 0 24 24"><path d="M22.675 0h-21.35C.595 0 0 .592 0 1.326v21.348C0 23.408.595 24 1.326 24H12.82v-9.294H9.692v-3.622h3.127V8.413c0-3.1 1.893-4.788 4.659-4.788 1.325 0 2.463.099 2.797.143v3.24l-1.918.001c-1.504 0-1.797.715-1.797 1.763v2.313h3.587l-.467 3.622h-3.12V24h6.116C23.406 24 24 23.408 24 22.674V1.326C24 .592 23.406 0 22.675 0"/></svg></a>
            </div>
          </div>
        </div>
      </div>
      <div className="text-center text-gray-400 text-sm mt-8">
        © 2025 Alra Labs. All rights reserved. | Privacy Policy | Terms of Service
      </div>
    </footer>
  );
};

export default AnimationWireframeSection;