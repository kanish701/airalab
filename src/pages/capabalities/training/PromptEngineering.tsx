import aiChip from '../../../assets/Prompt-Engineering.jpeg';
import jupiterNotebook from '../../../assets/jupyter logo.png';
import kaggleLogo from '../../../assets/kaggle logo.png';
import githubLogo from '../../../assets/github logo.png';
import img1 from '../../../assets/logo1.png'; // Assuming this is Python logo or similar
...
const learnItems = [
  ...
  },
  {
    title: 'AI Models &',
    subtitle: 'Platforms',
    desc: 'Get hands-on practice with leading AI tools like GPT (OpenAI), Gemini (Google), Claude (Anthropic), and beginner-friendly open-source models to understand their strengths and differences.',
    icon: (
  ...
  },
  {
    ...
    subtitle: 'Industries',
    desc: 'Apply your learning with beginner-friendly projects like spam email detection, stock price prediction using regression, and building a basic chatbot to understand real-world AI workflows.',
    icon: (
...
const PromptEngineering = () => {
  return (
    <div className="bg-[#181818] min-h-screen text-white pb-16 pt-16">
      {/* Breadcrumb */}
      <div className="text-gray-400 text-xs pt-8 pl-6">Home | Capabilities | Prompt Engineering</div>
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-16 max-w-7xl w-full">
          ...
          <div className="flex-1 max-w-2xl text-center lg:text-left">
            ...
            <p className="text-gray-200 text-base sm:text-lg lg:text-xl leading-relaxed">
              This course is designed for students, professionals, and innovators who want to learn how to communicate effectively with AI systems to generate accurate, creative, and business-ready outputs. At AI Labs, we combine theory with hands-on practice, teaching you to build prompts that drive intelligent results.
            </p>
          </div>
            ...
            <div className="flex-1 flex flex-col md:flex-row gap-8 md:gap-12 lg:gap-16">
              ...
              <div className="flex flex-col gap-8 md:gap-10 lg:gap-12 flex-1">
                <div className="flex items-start gap-3 md:gap-4">
                  ...
                  <div className="flex-1 pt-1 md:pt-2">
                    <span className="text-lg md:text-xl lg:text-2xl text-white leading-tight">
                      Design effective<br />prompts for a wide<br />range of AI models
                    </span>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 md:gap-4">
                  ...
                  <div className="flex-1 pt-1 md:pt-2">
                    <span className="text-lg md:text-xl lg:text-2xl text-white leading-tight">
                      Optimize prompts<br />for accuracy,<br />creativity & efficiency
                    </span>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 md:gap-4">
                  ...
                  <div className="flex-1 pt-1 md:pt-2">
                    <span className="text-lg md:text-xl lg:text-2xl text-white leading-tight">
                      Build AI-powered<br />tools using prompt<br />workflows
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-8 md:gap-10 lg:gap-12 flex-1 ">
                <div className="flex items-start gap-3 md:gap-4">
                  ...
                  <div className="flex-1 pt-1 md:pt-2">
                    <span className="text-lg md:text-xl lg:text-2xl text-white leading-tight">
                      Understand ethical<br />considerations in<br />prompt design
                    </span>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 md:gap-4">
                  ...
                  <div className="flex-1 pt-1 md:pt-2">
                    <span className="text-lg md:text-xl lg:text-2xl text-white leading-tight">
                      Showcase a<br />portfolio of mini<br />AI projects
                    </span>
                  </div>
                </div>
              </div>
