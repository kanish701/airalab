...
import { 
    BookOpen, Cpu, Network, Database, Wrench, Scale, 
    ArrowRight 
} from 'lucide-react';
...
import img1 from '../../../assets/logo1.png'; // Python Logo
    ...
    <div className="relative bg-[#0a0a0a] min-h-screen text-white overflow-hidden font-sans">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 pt-24 pb-20">
        ...
        >
            ...
            <span className="text-gray-700">/</span>
            <span className="text-yellow-500 font-medium">AI Fundamentals</span>
        </motion.div>
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20 mb-24">
            ...
            >
                <div className="inline-block px-3 py-1 mb-4 border border-blue-500/30 rounded-full bg-blue-500/10 text-blue-400 text-xs font-bold tracking-widest uppercase">
                    Core Module
                </div>
                <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-6 tracking-tight">
                    AI <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-500">Foundation</span>
                </h1>
                ...
                <p className="text-gray-400 text-lg leading-relaxed max-w-2xl mx-auto lg:mx-0">
                    Designed for students, beginners, and working professionals. Whether you're exploring AI for the first time or looking to upskill, 
                    this course equips you with the essential knowledge and practical skills to move forward with confidence.
                </p>
            </motion.div>
            ...
            >
                <div className="relative aspect-square md:aspect-[4/3] rounded-3xl overflow-hidden border border-white/10 shadow-2xl shadow-blue-500/10">
                    <img 
                        src={aiChip} 
                        alt="AI Chip" 
